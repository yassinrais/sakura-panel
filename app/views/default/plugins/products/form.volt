...
<!-- DataTales Example -->
  	<div class="card shadow mt-0 mb-4">
	    <div class="card-header py-3">
	      <h6 class="m-0 font-weight-bold">{% if row is defined and row.id is defined %}Edit Product {{ row.id }}{% else %}Create New Product{% endif %}</h6>
	    </div>
	    <div class="card-body">
	    	<form method="post" >
		    	...
		    	<div class="form-group"><label>Image</label> {{ form.render('image') }} </div>
