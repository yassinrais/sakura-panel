    ...
    <div class="auth-rside  vcenter-item col-12 col-lg-5">
      <div class="p-5 ">
        <div class="text-center">
          <h1 class="pb-3 text-gray-900 mb-4">{{_("Login to continue")}}</h1>
        </div>
        <form class="user auth-form" action="auth/ajaxLogin" method="post">
          ...
          <div class="wrap-input validate-input">
            ...
            <span class="label-input">{{_("Email")}}</span>
          </div>
          <div class="wrap-input validate-input">
            <span class="focus-input"></span>
            {{ 
            ...
            <span class="focus-input"></span>
            <span class="label-input">{{_("Password")}}</span>
          </div>
          {{
          ...
          <div class="form-group">
            <div class="custom-control custom-checkbox small">
              ...
              <label class="custom-control-label" for="checkbox_rmb">{{_("Remember Me")}}</label>
            </div>
          </div>
          <button type="submit" name="action" value="login" class="btn btn-primary btn-user btn-block">
            <i class="fas fa-key"></i> {{_("Login")}}
          </button>
        </form>
        <!-- <hr> -->
        <!-- <div class="text-center">
